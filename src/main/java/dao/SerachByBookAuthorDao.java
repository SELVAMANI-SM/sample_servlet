...
public class SerachByBookAuthorDao {
public static  List<BooksDetails> bookAuthor( String name) throws Exception
{
	...
	String query="SELECT * FROM books_library WHERE Author LIKE '%"+name+"%'";
