...
public class SerachByBookNameDao {


	public static List<BooksDetails> bookname( String name) throws Exception
	{
		...
		String query="SELECT * FROM books_library WHERE Books_Name LIKE '%"+name+"%'";
